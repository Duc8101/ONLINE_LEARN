    ...
    <div class="container">
        ...
        <div class="owl-carousel testimonial-carousel position-relative">
            <div class="testimonial-item text-center">
                <img class="border rounded-circle p-2 mx-auto mb-3" src="<c:url value="/resources/img/testimonial-1.jpg"></c:url>" style="width: 80px; height: 80px;">
            ...
            <div class="testimonial-item text-center">
                <img class="border rounded-circle p-2 mx-auto mb-3" src="<c:url value="/resources/img/testimonial-2.jpg"></c:url>" style="width: 80px; height: 80px;">
            ...
            <div class="testimonial-item text-center">
                <img class="border rounded-circle p-2 mx-auto mb-3" src="<c:url value="/resources/img/testimonial-3.jpg"></c:url>" style="width: 80px; height: 80px;">
            ...
            <div class="testimonial-item text-center">
                <img class="border rounded-circle p-2 mx-auto mb-3" src="<c:url value="/resources/img/testimonial-4.jpg"></c:url>" style="width: 80px; height: 80px;">
